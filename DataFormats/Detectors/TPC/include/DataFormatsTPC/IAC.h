...
/// \file IAC.h
/// \brief Integrated analogue currents data format definitions
/// @author Jens Wiechula, Jens.Wiechula@ikf.uni-frankfurt.de

#ifndef ALICEO2_DATAFORMATSTPC_IAC_H
#define ALICEO2_DATAFORMATSTPC_IAC_H
...
/// 256bit CRU header word of IACs
struct headerDef {
  ...
  union {
    ...
    struct {                       ///
      ...
      uint32_t bunchCrossing : 12; ///< bunch crossing when IAC packet was received
      uint32_t orbit : 32;         ///< orbit when IAC packet was received
    };                             ///
  };                               ///
                                   ///
  union {                          ///
...
struct dataDef {
  ...
  char dataWords[DataSize];  ///< ASCI encoded IAC data
